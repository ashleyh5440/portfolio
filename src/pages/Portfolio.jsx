        ...
        <section className="portfolio">
            ...
            <div className="projects-container">
                ...
                <div id="left">
                    ...
                    <div className="app-button"> <a href="https://gods-and-beasts-game-15c8c3fec868.herokuapp.com/" target="_blank"><Button variant="primary">Visit site</Button></a></div>
                    ...
                    <div className="app-button"> <a href="https://ashleyh5440.github.io/new-prework-study-guide/" target="_blank"><Button variant="primary">Visit site</Button></a></div>
                    ...
                    <div className="app-button"> <a href="https://art-trivia-game.onrender.com/" target="_blank"><Button variant="primary">Visit site</Button></a></div>
                </div>
                <div id="right">
                    {/* the box office dojo */}
                    ...
                    <div className="app-button"> <a href="https://ashleyh5440.github.io/box-office-dojo/" target="_blank"><Button variant="primary">Visit site</Button></a></div>
                    ...
                    <div className="app-button"> <a href="https://ashleyh5440.github.io/pro-portfolio/" target="_blank"><Button variant="primary">Visit site</Button></a></div>
                    ...
                    <div className="app-button"> <a href="https://ashleyh5440.github.io/password-generator/" target="_blank"><Button variant="primary">Visit site</Button></a></div>
                </div>
           </div>
        </section>
    )
